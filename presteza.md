...
[REFERÊNCIA](#tooltip "Bodart & Vanderdonckt [1993] pg 68 rec 2, Smith & Mosier [1986] pg 56 rec 1.4.20")
...
[REFERÊNCIA](#tooltip "Bodart & Vanderdonckt [1993] pg 68 rec 5, Smith & Mosier [1986] pg 57 rec 1.4.21+ pg 118 rec 2.2.2*10")

### 5. Os rótulos dos campos contêm um elemento específico, por exemplo ":", como convite às entradas de dados?

Defina um símbolo padrão para o convite à interação e reserve esse símbolo apenas para esse uso.
...
Cabeçalhos para linhas e colunas.

Rotule as fileiras e colunas das tabelas seguindo as recomendações propostas para rotular os campos e mostradores de dados.
...
Títulos para o gráfico e seus eixos.
...
Indicadores de continuidade do diálogo para os botões de comando.
...
Cabeçalhos para páginas de menus.
...
Indicadores da continuidade de diálogo para opções de menu.
...
Informações necessárias sempre presentes nas telas.
...
Lista de comandos básicos à mão.
